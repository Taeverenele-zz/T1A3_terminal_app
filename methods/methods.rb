...
def featureUnfinished
    pastel = Pastel.new
    puts pastel.red("This feature is still a working process.")
    puts pastel.red("Apologies for the inconvenience caused. We will get this up and running as soon as possible.")
end